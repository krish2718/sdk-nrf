...
#if defined(MBEDTLS_PLATFORM_C) && !defined(CONFIG_WPA_SUPP_CRYPTO_NONE) && !defined(CONFIG_MBEDTLS_ENABLE_HEAP)
...
#if defined(CONFIG_WPA_SUPP_CRYPTO_NONE) && !defined(CONFIG_WPA_SUPP_CRYPTO_NONE) && !defined(CONFIG_MBEDTLS_ENABLE_HEAP)
