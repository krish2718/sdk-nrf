...
1. Install protobuf compiler and Python dependencies by running the following command:

   .. code-block:: bash

      pip install protobuf

#. Generate protobuf definitions by running the following command:

   .. code-block:: bash

      cd subsys/net/lib/wifi_prov_core/proto
      make generate
