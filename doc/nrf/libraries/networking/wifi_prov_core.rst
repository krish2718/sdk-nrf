...
The core library is designed to work with various transport layers (Bluetooth® LE, USB, UART, etc.) through a defined transport interface.
...
* Wi-Fi management interface for network operations (:ref:`lib_wifi_mgmt`).
