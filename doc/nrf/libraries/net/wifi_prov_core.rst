.. _wifi_prov_core_readme:

Wi-Fi Provisioning Core Library
###############################
...
It provides the protocol implementation, message handling, and configuration management for Wi-Fi provisioning.
The core library is designed to work with various transport layers (BLE, USB, UART, etc.) through a defined transport interface.
...
* Wi-Fi credentials library for configuration management
* Wi-Fi management interface for network operations
* Zephyr kernel and networking stack
