...
Content that applies to all nRF Wi-Fi devices is kept generic, while content that is specific to a device family is documented in the corresponding device guide.
