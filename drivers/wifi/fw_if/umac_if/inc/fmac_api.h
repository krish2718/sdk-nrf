 ...
 *
 * This function is used to send a command (%WIFI_NRF_CMD_GET_STATS) to
 * instruct the firmware to return the current RPU statistics. The RPU will
 * send the event (%WIFI_NRF_EVENT_STATS) with the current statistics.
 *
 * Returns: Status
 *		Pass: %WIFI_NRF_STATUS_SUCCESS
 *		Fail: %WIFI_NRF_STATUS_FAIL
 ...
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_TRIGGER_SCAN) to
 ...
 *		Fail: %WIFI_NRF_STATUS_FAIL
 */
enum wifi_nrf_status wifi_nrf_fmac_scan(void *wifi_nrf_fmac_dev_ctx, unsigned char wifi_nrf_if_idx,
 ...
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_GET_SCAN_RESULTS) to
 ...
 *             request.
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_AUTHENTICATE) to
 ...
 *		Fail: %WIFI_NRF_STATUS_FAIL
 */
enum wifi_nrf_status wifi_nrf_fmac_auth(void *wifi_nrf_fmac_dev_ctx, unsigned char wifi_nrf_if_idx,
 ...
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_DEAUTHENTICATE) to
 ...
 *              request.
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_ASSOCIATE) to
 ...
 *		Fail: %WIFI_NRF_STATUS_FAIL
 */
enum wifi_nrf_status wifi_nrf_fmac_assoc(void *wifi_nrf_fmac_dev_ctx, unsigned char wifi_nrf_if_idx,
 ...
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_DISASSOCIATION) to
 ...
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_NEW_KEY) to
 ...
 * @mac_addr: MAC address of the peer with which the key is associated.
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_DEL_KEY) to
 ...
 * @key_info: Key specific information which needs to be passed to the RPU.
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_SET_KEY) to
 ...
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_SET_BSS) to
 ...
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_SET_BEACON) to
 ...
 *           RPU.
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_START_AP) to
 ...
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_STOP_AP) to
 ...
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_START_P2P_DEVICE) to
 ...
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_REMAIN_ON_CHANNEL)
 ...
 * (%WIFI_NRF_UMAC_CMD_CANCEL_REMAIN_ON_CHANNEL) to RPU to put p2p device out
 * of listen state.
 *
 * Returns: Status
 *		 Pass: %WIFI_NRF_FMAC_STATUS_SUCCESS
 ...
 * This is done using the command %WIFI_NRF_UMAC_CMD_FRAME.
 *
 * Returns: Status
 *		Pass: %WIFI_NRF_STATUS_SUCCESS
 *		Fail: %WIFI_NRF_STATUS_FAIL
 ...
 * command %WIFI_NRF_UMAC_CMD_DEL_STATION.
 *
 * Returns: Status
 *		Pass: %WIFI_NRF_STATUS_SUCCESS
 *		Fail: %WIFI_NRF_STATUS_FAIL
 ...
 * using the command %WIFI_NRF_UMAC_CMD_NEW_STATION.
 *
 * Returns: Status
 *		Pass: %WIFI_NRF_STATUS_SUCCESS
 *		Fail: %WIFI_NRF_STATUS_FAIL
 ...
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_REGISTER_FRAME) to
 ...
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_NEW_INTERFACE) to
 ...
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_DEL_INTERFACE) to
 ...
 * %WIFI_NRF_UMAC_CMD_SET_INTERFACE.
 *
 * Returns: Status
 *		Pass: %WIFI_NRF_STATUS_SUCCESS
 *		Fail: %WIFI_NRF_STATUS_FAIL
 ...
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_SET_IFFLAGS) to
...
enum wifi_nrf_status wifi_nrf_fmac_start_xmit(void *wifi_nrf_fmac_dev_ctx,
					      unsigned char wifi_nrf_if_idx, void *netbuf);
 ...
 * @wifi_nrf_fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_SUSPEND) to
 ...
 * @wifi_nrf_fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_RESUME)
 ...
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_GET_TX_POWER)
 ...
 * @wifi_nrf_vif_idx: VIF index.
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_GET_CHANNEL)
 ...
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_GET_STATION)
 ...
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_SET_POWER_SAVE)
...
enum wifi_nrf_status wifi_nrf_fmac_set_power_save(void *wifi_nrf_fmac_dev_ctx,
						  unsigned char wifi_nrf_if_idx, bool state);
 ...
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_SET_QOS_MAP)
 ...
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_SET_WOWLAN)
 ...
 *
 * This function is used to send a command (%WIFI_NRF_UMAC_CMD_SET_WIPHY)
 ...
 *
 * This function is used to send a command (%WIFI_NRF_CMD_BTCOEX) to RPU to configure
