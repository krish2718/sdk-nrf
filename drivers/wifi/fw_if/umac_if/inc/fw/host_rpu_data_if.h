 ...
 * @ddr_ptrs: Managment DDR buffer pointers.
 *
 ...
 *
 */
enum img_rx_pkt_type {
	IMG_RX_PKT_DATA,
	IMG_RX_PKT_BCN_PRB_RSP
};
 ...
 * @umac_head: UMAC event header. See &struct img_umac_hdr.
 * @wdev_id: wdev interface id.
 * @rx_pkt_cnt: Number of packets recieved.
