 ...
 * @umac_hdr: UMAC event header. Refer &struct img_umac_hdr.
 * @valid_fields: Indicate which of the following parameters are valid.
 * @info: Information about the mangement frame to be transmitted.
 *
 ...
 * @is_implicit:1->implicit(same negotiated values to be used), 0->AP sends new calculated TWT values
 *		for every service period.
 * @twt_flow_type: Wether STA has to send the PS-Poll/Null frame
