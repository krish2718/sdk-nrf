...
struct host_rpu_msg *umac_cmd_alloc(struct wifi_nrf_fmac_dev_ctx *fmac_dev_ctx, int type, int size);

enum wifi_nrf_status umac_cmd_cfg(struct wifi_nrf_fmac_dev_ctx *fmac_dev_ctx, void *params,
				  int len);
...
int umac_event_cfg(void *rpu_ctx_lnx, void *vif_ctx_lnx, unsigned int event_num, void *event_data,
