...
/**
 * enum nvlsi_wlan_fmac_ac - WLAN access categories.
...
/**
 * enum nvlsi_wlan_fmac_if_state - The operational state of an interface.
...
/**
 * struct nvlsi_wlan_fmac_callbk_fns - Callback functions to be invoked by UMAC
 ...
 */
struct nvlsi_wlan_fmac_callbk_fns {
	enum nvlsi_rpu_status (*if_state_chg_callbk_fn)(void *os_vif_ctx,
...
struct nvlsi_wlan_fmac_buf_map_info {
	bool mapped;
	unsigned long nwb;
};
...
/**
 * struct nvlsi_wlan_fmac_init_dev_params - Structure to hold parameters for
 ...
 */
struct nvlsi_wlan_fmac_init_dev_params {
 ...
 * @nvlsi_vif_idx: Index of the VIF on which the peer is connected.
...
/**
 * struct nvlsi_wlan_fmac_priv - Structure to hold context information for the
 *                             UMAC IF layer.
...
/**
 * struct nvlsi_wlan_fmac_dev_ctx - Structure to hold per device context information
 ...
 */
struct nvlsi_wlan_fmac_dev_ctx {
	struct nvlsi_wlan_fmac_priv *fpriv;
	void *os_dev_ctx;
	void *hal_dev_ctx;
	struct nvlsi_wlan_fmac_vif_ctx *vif_ctx[MAX_NUM_VIFS];
	struct nvlsi_wlan_fmac_buf_map_info *tx_buf_info;
	struct nvlsi_wlan_fmac_buf_map_info *rx_buf_info;
...
/**
 * struct nvlsi_wlan_fmac_vif_ctx - Structure to hold per VIF context information
 *                                for the UMAC IF layer.
 ...
 */
struct nvlsi_wlan_fmac_vif_ctx {
...
/**
 * struct nvlsi_wlan_fmac_fw_info - Structure to hold firmware information
 *                                for the UMAC IF layer.
 ...
 */
struct nvlsi_wlan_fmac_fw_info {
	struct nvlsi_wlan_fw_info lmac_patch_pri;
	struct nvlsi_wlan_fw_info lmac_patch_sec;
	struct nvlsi_wlan_fw_info umac_patch_pri;
	struct nvlsi_wlan_fw_info umac_patch_sec;
};
