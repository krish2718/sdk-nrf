...
### cd drivers; ./scripts/fullmac/generate_driver_calder.sh

PROJECT=CALDER
ENABLE="SOC_CALDER RPU_CONFIG_FMAC RPU_32_BIT_DMA_SUPPORT RPU_SUPPORT_WAPI RPU_BSS_DB_SUPPORT"
DISABLE="notyet disabled RPU_RESTRICTED_DMA HACK_SERDES_CONFIG RPU_MODE_EXPLORER HACK_MONITOR_MODE RPU_CONFIG_72"
