...
ENABLE="RPU_MODE_EXPLORER MULTI_CHAN_SUPPORT HAL_PCIE RPU_DMA_ZONE RPU_ACCESS_FULL_DDR RPU_SGI_SUPPORT SOC_ST RPU_HPQM_SUPPORT DEV_BOARD_VCU108 SOC_DONATELLO RPU_DFS_SUPPORT RPU_2GBAND_SUPPORT RPU_5GBAND_SUPPORT"
...
cp -r $PWD/Makefile.donatello $PWD/$PROJECT/
