...
enum NVLSI_RPU_REGION_TYPE {
	NVLSI_RPU_REGION_TYPE_GRAM,
	NVLSI_RPU_REGION_TYPE_PKTRAM,
	NVLSI_RPU_REGION_TYPE_SYSBUS,
	NVLSI_RPU_REGION_TYPE_PBUS,
	NVLSI_RPU_REGION_TYPE_LMAC_CORE_ROM,
	NVLSI_RPU_REGION_TYPE_LMAC_CORE_RET,
	NVLSI_RPU_REGION_TYPE_LMAC_CORE_SCRATCH,
	NVLSI_RPU_REGION_TYPE_UMAC_CORE_ROM,
	NVLSI_RPU_REGION_TYPE_UMAC_CORE_RET,
	NVLSI_RPU_REGION_TYPE_UMAC_CORE_SCRATCH,
	NVLSI_RPU_REGION_TYPE_MAX
};


enum NVLSI_RPU_HAL_MSG_TYPE {
	NVLSI_RPU_HAL_MSG_TYPE_CMD_CTRL,
	NVLSI_RPU_HAL_MSG_TYPE_EVENT,
	NVLSI_RPU_HAL_MSG_TYPE_CMD_DATA_RX,
	NVLSI_RPU_HAL_MSG_TYPE_CMD_DATA_MGMT,
	NVLSI_RPU_HAL_MSG_TYPE_CMD_DATA_TX,
	NVLSI_RPU_HAL_MSG_TYPE_MAX,
};
