...
#define RPU_ADDR_MCU1_CORE_RET_END 0x800477FF
...
#define PWR_CTRL1 0xA4019000
#define PWR_COUNTERSTART 0xA40190A0
#define PWR_COUNTERCYCLES 0xA40190A4
#define PWR_COUNTERSTATUS0 0xA40190B0
#define PWR_COUNTERSTATUS1 0xA40190B4
#define PWR_COUNTERSTATUS2 0xA40190B8
#define PWR_COUNTERSTATUS3 0xA40190BC
#define WL_PWR_MON 0xA4009310
#define WL_PWR_AUX 0xA4009314
#define WL_PWR_VMON_CTRL 0xA4009330
#define WL_PWR_VMON_DATA 0xA4009334
#define WLAFE_WL_BBPLLEN 0xA400B004
#define WLAFE_RG_BBPLL_CLK_01 0xA400B050
#define WLAFE_RG_AFE_LDOCTRL 0xA400B0F0

#define PWR_BREAKTIMER90                          0xA4019190
#define PWR_BREAKCOND2                            0xA4019094
#define PWR_BREAK3                                0xA4019080
#define PWR_BREAKCOND3                            0xA4019098
#define PWR_BREAK5                                0xA4019088
...
#define PWR_CTRL1 0x1040
#define PWR_COUNTERSTART 0x1158
#define PWR_COUNTERCYCLES 0x1159
#define PWR_COUNTERSTATUS0 0x115C
#define PWR_COUNTERSTATUS1 0x115D
#define PWR_COUNTERSTATUS2 0x115E
#define PWR_COUNTERSTATUS3 0x115F
#define WL_PWR_MON 0x0144
#define WL_PWR_AUX 0x0145

#define PWR_BREAKTIMER90                          0x1264
#define PWR_BREAKCOND2                            0x1155
#define PWR_BREAK3                                0x1150
#define PWR_BREAKCOND3                            0x1156
#define PWR_BREAK5                                0x1152
...
#define RPU_MEM_TX_CMD_BASE 0xB000005C
#else   /* INLINE_MODE, INLINE_BB_MODE */
#define RPU_MEM_HPQ_INFO 0xB700D368
#define RPU_MEM_TX_CMD_BASE 0xB700D3A4
#endif /* OFFLINE_MODE */
...
enum img_rpu_pwr_data_type {
	IMG_RPU_PWR_DATA_TYPE_LFC_ERR,
	IMG_RPU_PWR_DATA_TYPE_VBAT_MON,
	IMG_RPU_PWR_DATA_TYPE_TEMP,
	IMG_RPU_PWR_DATA_TYPE_ALL,
	IMG_RPU_PWR_DATA_TYPE_MAX
};

#ifndef RPU_RF_C0_SUPPORT
enum img_rpu_rf_clk_type {
	IMG_RPU_RF_CLK_TYPE_20,
	IMG_RPU_RF_CLK_TYPE_40,
	IMG_RPU_RF_CLK_TYPE_MAX
};
#endif /* RPU_RF_C0_SUPPORT */
...
PACK(
struct ptaExtParams {
	/* !Set polarity to 1 if  BT_TX_RX active high indicates Tx. Set polarity to 0 if  BT_TX_RX active
	 * high indicates Rx.
	 */
	unsigned char txRxPol;

	/* ! BT_ACTIVE signal lead time period. This is with reference to "time instance at which
	 * “BT slot boundary starts if BT supports classic only mode” and “BT activity starts if BT supports
	 * BLE or dual mode”
	 */
	unsigned int leadTime;

	/* ! Time instance at which BT_STATUS is sampled by PTA to get the BT_PTI information. This is done
	 * anywhere between BT_ACTIVE_ASSERT time and BT_STATUS priority signalling time period ends.
	 * This is with reference to BT_ACTIVE assert time.
	 */
	unsigned int ptiSampTime;

	/* ! Time instance at which BT_STATUS is sampled by PTA to get BT_TX_RX information.
	 * This is done by PTA “after the end of time period T2”.  This is with reference to BT_ACTIVE assert time.
	 */
	unsigned int txRxSampTime;

	/* ! Time instance at which PTA takes arbitration decision and posts WLAN_DENY to BT. This is with
	 * reference to BT_ACTIVE assert time.
	 */
