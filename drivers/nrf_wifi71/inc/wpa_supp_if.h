...
#ifndef __WIFI71_WPA_SUPP_IF_H__
#define __WIFI71_WPA_SUPP_IF_H__
...
void nrf_wifi_wpa_supp_event_get_wiphy(void *if_priv, struct nrf_wifi_event_get_wiphy *get_wiphy,
				       unsigned int event_len);
...
#endif /*  __WIFI71_WPA_SUPP_IF_H__ */
