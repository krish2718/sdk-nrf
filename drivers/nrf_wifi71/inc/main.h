...
#ifndef __WIFI71_MAIN_H__
#define __WIFI71_MAIN_H__
...
#define NRF71_DRIVER_VERSION "2." KERNEL_VERSION_STRING

enum nrf71_wifi_status {
	NRF71_WIFI_STATUS_SUCCESS = 0,
	NRF71_WIFI_STATUS_FAIL = -1,
};
