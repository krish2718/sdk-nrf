...
LOG_MODULE_DECLARE(wifi_nrf71, CONFIG_WIFI_NRF71_LOG_LEVEL);
...
#define TOTAL_TX_SIZE     (CONFIG_NRF71_MAX_TX_TOKENS * CONFIG_NRF71_TX_MAX_DATA_SIZE)
#define TOTAL_RX_SIZE     (CONFIG_NRF71_RX_NUM_BUFS * CONFIG_NRF71_RX_MAX_DATA_SIZE)

BUILD_ASSERT(CONFIG_NRF71_MAX_TX_TOKENS >= 1, "At least one TX token is required");
BUILD_ASSERT(CONFIG_NRF71_MAX_TX_AGGREGATION <= 15, "Max TX aggregation is 15");
BUILD_ASSERT(CONFIG_NRF71_RX_NUM_BUFS >= 1, "At least one RX buffer is required");
...
void nrf_wifi_event_proc_scan_done_zep(void *vif_ctx,
				       ...
				       unsigned int event_len)
{
	enum nrf71_wifi_status status = NRF71_WIFI_STATUS_FAIL;
	struct nrf_wifi_vif_ctx_zep *vif_ctx_zep = NULL;
	...
	case SCAN_DISPLAY:
		...
		if (status != NRF71_WIFI_STATUS_SUCCESS) {
	...
	status = NRF71_WIFI_STATUS_SUCCESS;
}
			  ...
			  unsigned int event_len)
{
	...
	fmac_dev_ctx->reg_change =
		nrf_wifi_osal_mem_alloc(sizeof(struct nrf_wifi_event_regulatory_change));
...
#define DT_WIFI_PROP(label) DT_PROP(DT_NODELABEL(wifi), label)

void configure_tx_pwr_settings(struct nrf_wifi_tx_pwr_ctrl_params *tx_pwr_ctrl_params,
				   struct nrf_wifi_tx_pwr_ceil_params *tx_pwr_ceil_params)
{
	const struct device *dev = DEVICE_DT_GET_ANY(nordic_wlan);

	/* Antenna gains from DTS */
	tx_pwr_ctrl_params->ant_gain_2g = DT_WIFI_PROP(wifi_ant_gain_2g);
	tx_pwr_ctrl_params->ant_gain_5g_band1 = DT_WIFI_PROP(wifi_ant_gain_5g_band1);
	tx_pwr_ctrl_params->ant_gain_5g_band2 = DT_WIFI_PROP(wifi_ant_gain_5g_band2);
	tx_pwr_ctrl_params->ant_gain_5g_band3 = DT_WIFI_PROP(wifi_ant_gain_5g_band3);

	/* 2.4GHz band edge backoffs from DTS */
	tx_pwr_ctrl_params->band_edge_2g_lo_dss = DT_WIFI_PROP(wifi_band_edge_2g_lo_dss);
	tx_pwr_ctrl_params->band_edge_2g_lo_ht = DT_WIFI_PROP(wifi_band_edge_2g_lo_ht);
	tx_pwr_ctrl_params->band_edge_2g_lo_he = DT_WIFI_PROP(wifi_band_edge_2g_lo_he);
	tx_pwr_ctrl_params->band_edge_2g_hi_dsss = DT_WIFI_PROP(wifi_band_edge_2g_hi_dsss);
	tx_pwr_ctrl_params->band_edge_2g_hi_ht = DT_WIFI_PROP(wifi_band_edge_2g_hi_ht);
	tx_pwr_ctrl_params->band_edge_2g_hi_he = DT_WIFI_PROP(wifi_band_edge_2g_hi_he);

	/* 5GHz band edge backoffs from DTS */
	/* UNII-1 */
	tx_pwr_ctrl_params->band_edge_5g_unii_1_lo_ht = DT_WIFI_PROP(wifi_band_edge_5g_unii_1_lo_ht);
	tx_pwr_ctrl_params->band_edge_5g_unii_1_lo_he = DT_WIFI_PROP(wifi_band_edge_5g_unii_1_lo_he);
	tx_pwr_ctrl_params->band_edge_5g_unii_1_hi_ht = DT_WIFI_PROP(wifi_band_edge_5g_unii_1_hi_ht);
	tx_pwr_ctrl_params->band_edge_5g_unii_1_hi_he = DT_WIFI_PROP(wifi_band_edge_5g_unii_1_hi_he);

	/* UNII-2A */
	tx_pwr_ctrl_params->band_edge_5g_unii_2a_lo_ht = DT_WIFI_PROP(wifi_band_edge_5g_unii_2a_lo_ht);
	tx_pwr_ctrl_params->band_edge_5g_unii_2a_lo_he = DT_WIFI_PROP(wifi_band_edge_5g_unii_2a_lo_he);
	tx_pwr_ctrl_params->band_edge_5g_unii_2a_hi_ht = DT_WIFI_PROP(wifi_band_edge_5g_unii_2a_hi_ht);
	tx_pwr_ctrl_params->band_edge_5g_unii_2a_hi_he = DT_WIFI_PROP(wifi_band_edge_5g_unii_2a_hi_he);

	/* UNII-2C */
	tx_pwr_ctrl_params->band_edge_5g_unii_2c_lo_ht = DT_WIFI_PROP(wifi_band_edge_5g_unii_2c_lo_ht);
	tx_pwr_ctrl_params->band_edge_5g_unii_2c_lo_he = DT_WIFI_PROP(wifi_band_edge_5g_unii_2c_lo_he);
	tx_pwr_ctrl_params->band_edge_5g_unii_2c_hi_ht = DT_WIFI_PROP(wifi_band_edge_5g_unii_2c_hi_ht);
	tx_pwr_ctrl_params->band_edge_5g_unii_2c_hi_he = DT_WIFI_PROP(wifi_band_edge_5g_unii_2c_hi_he);

	/* UNII-3 */
	tx_pwr_ctrl_params->band_edge_5g_unii_3_lo_ht = DT_WIFI_PROP(wifi_band_edge_5g_unii_3_lo_ht);
	tx_pwr_ctrl_params->band_edge_5g_unii_3_lo_he = DT_WIFI_PROP(wifi_band_edge_5g_unii_3_lo_he);
	tx_pwr_ctrl_params->band_edge_5g_unii_3_hi_ht = DT_WIFI_PROP(wifi_band_edge_5g_unii_3_hi_ht);
	tx_pwr_ctrl_params->band_edge_5g_unii_3_hi_he = DT_WIFI_PROP(wifi_band_edge_5g_unii_3_hi_he);

	/* UNII-4 */
	tx_pwr_ctrl_params->band_edge_5g_unii_4_lo_ht = DT_WIFI_PROP(wifi_band_edge_5g_unii_4_lo_ht);
	tx_pwr_ctrl_params->band_edge_5g_unii_4_lo_he = DT_WIFI_PROP(wifi_band_edge_5g_unii_4_lo_he);
	tx_pwr_ctrl_params->band_edge_5g_unii_4_hi_ht = DT_WIFI_PROP(wifi_band_edge_5g_unii_4_hi_ht);
	tx_pwr_ctrl_params->band_edge_5g_unii_4_hi_he = DT_WIFI_PROP(wifi_band_edge_5g_unii_4_hi_he);
...
{
	board_params->pcb_loss_2g = DT_WIFI_PROP(wifi_pcb_loss_2g);
	board_params->pcb_loss_5g_band1 = DT_WIFI_PROP(wifi_pcb_loss_5g_band1);
	board_params->pcb_loss_5g_band2 = DT_WIFI_PROP(wifi_pcb_loss_5g_band2);
	board_params->pcb_loss_5g_band3 = DT_WIFI_PROP(wifi_pcb_loss_5g_band3);
}

enum nrf71_wifi_status nrf_wifi_fmac_dev_add_zep(struct nrf_wifi_drv_priv_zep *drv_priv_zep)
{
	enum nrf71_wifi_status status = NRF71_WIFI_STATUS_FAIL;
	struct nrf_wifi_ctx_zep *rpu_ctx_zep = NULL;
	void *rpu_ctx = NULL;
...
enum nrf71_wifi_status nrf_wifi_fmac_dev_rem_zep(struct nrf_wifi_drv_priv_zep *drv_priv_zep)
{
	struct nrf_wifi_ctx_zep *rpu_ctx_zep = NULL;
	...
	return NRF71_WIFI_STATUS_SUCCESS;
}
...
static int nrf_wifi_drv_main_zep(const struct device *dev)
{
	...
	rpu_drv_priv_zep.fmac_priv =
		nrf_wifi_sys_fmac_init(&data_config, rx_buf_pools, &callbk_fns);
	...
	sys_fpriv->max_ampdu_len_per_token =
		(RPU_PKTRAM_SIZE - (CONFIG_NRF71_RX_NUM_BUFS * CONFIG_NRF71_RX_MAX_DATA_SIZE)) /
		CONFIG_NRF71_MAX_TX_TOKENS;
	/* Align to 4-byte */
	sys_fpriv->max_ampdu_len_per_token &= ~0x3;

	/* Alignment overhead for size based coalesce */
	sys_fpriv->avail_ampdu_len_per_token = sys_fpriv->max_ampdu_len_per_token -
